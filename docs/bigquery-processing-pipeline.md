...
docker build -t gcr.io/knative-400704/${SERVICE_NAME}:v1 -f bigquery/${SERVICE_NAME}/csharp/Dockerfile .
...
docker build -t gcr.io/knative-400704/${SERVICE_NAME}:v1 .
docker push gcr.io/knative-400704/${SERVICE_NAME}:v1
```
...
gs://knative-400704-charts/chart-cyprus.png
gs://knative-400704-charts/chart-unitedkingdom.png
```
