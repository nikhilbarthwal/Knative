...
```bash
export PROJECT_ID=knative-363517
```
...
```bash
gcloud builds submit --tag gcr.io/knative-363517/helloworld:v1
```
...
```bash
gcloud run deploy --image gcr.io/knative-363517/helloworld:v1
...
Deploying container to Cloud Run service [helloworld] in project [knative-363517] region [europe-west1]
 Deploying... Done.
   Creating Revision...
   Routing traffic...
Done.
